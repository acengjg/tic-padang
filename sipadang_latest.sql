...
\restrict BXOuI2G1rFIXR57hjuVuN2ed6xmzpR0gFcVbytASatgslbuXhhiVc5FEfSAFCZ0
...
--
-- Name: BadgeTier; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public."BadgeTier" OWNER TO postgres;
...
--
-- Name: VisitType; Type: TYPE; Schema: public; Owner: postgres
--
...
ALTER TYPE public."VisitType" OWNER TO postgres;
...
CREATE TABLE public."Badge" (
    ...
    tier public."BadgeTier" DEFAULT 'BRONZE'::public."BadgeTier" NOT NULL,
    "createdAt" timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
);
...
--
-- Name: BookingMessage; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public."BookingMessage" OWNER TO postgres;
...
--
-- Name: ConversationMember; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public."ConversationMember" OWNER TO postgres;

--
-- Name: CulinaryMenu; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."CulinaryMenu" (
    id text NOT NULL,
...
ALTER TABLE public."CulinaryMenu" OWNER TO postgres;

--
-- Name: CulinaryReview; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."CulinaryReview" (
    id text NOT NULL,
    "spotId" text NOT NULL,
    "userId" text NOT NULL,
...
ALTER TABLE public."CulinaryReview" OWNER TO postgres;

--
-- Name: CulinarySpot; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."CulinarySpot" (
    id text NOT NULL,
    name text NOT NULL,
    category text NOT NULL,
    description text NOT NULL,
...
ALTER TABLE public."CulinarySpot" OWNER TO postgres;
...
CREATE TABLE public."Destination" (
    ...
    "audioNarration" text,
    hotspots jsonb,
    "isEnhanced" boolean DEFAULT false NOT NULL,
    scenes jsonb,
    "videoUrl" text
);
...
--
-- Name: Footprint; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public."Footprint" (
    ...
    "culinarySpotId" text,
    "eventId" text,
    type public."VisitType" DEFAULT 'MANUAL'::public."VisitType" NOT NULL,
...
ALTER TABLE public."Footprint" OWNER TO postgres;
...
--
-- Name: GuideEarning; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public."GuideEarning" OWNER TO postgres;

--
-- Name: GuideReview; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public."GuideReview" OWNER TO postgres;
...
--
-- Name: PackageReview; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public."PackageReview" OWNER TO postgres;
...
--
-- Name: PlanItem; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public."PlanItem" OWNER TO postgres;
...
--
-- Name: SouvenirOrder; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."SouvenirOrder" (
    id text NOT NULL,
    "userId" text NOT NULL,
...
ALTER TABLE public."SouvenirOrder" OWNER TO postgres;

--
-- Name: SouvenirOrderItem; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."SouvenirOrderItem" (
    id text NOT NULL,
...
ALTER TABLE public."SouvenirOrderItem" OWNER TO postgres;

--
-- Name: SouvenirProduct; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."SouvenirProduct" (
    id text NOT NULL,
    "vendorId" text NOT NULL,
    name text NOT NULL,
    description text NOT NULL,
...
ALTER TABLE public."SouvenirProduct" OWNER TO postgres;

--
-- Name: SouvenirVendor; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."SouvenirVendor" (
    id text NOT NULL,
    name text NOT NULL,
    description text NOT NULL,
    image text NOT NULL,
...
ALTER TABLE public."SouvenirVendor" OWNER TO postgres;
...
--
-- Name: StoryComment; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public."StoryComment" OWNER TO postgres;

--
-- Name: StoryLike; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public."StoryLike" OWNER TO postgres;

--
-- Name: StoryMedia; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public."StoryMedia" OWNER TO postgres;
...
--
-- Name: TravelBuddyApplication; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public."TravelBuddyApplication" OWNER TO postgres;

--
-- Name: TravelBuddyPost; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public."TravelBuddyPost" OWNER TO postgres;
...
COPY public."Badge" (id, name, description, image, category, threshold, tier, "createdAt") FROM stdin;
\.
...
--
-- Data for Name: BookingMessage; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
cmldqgith0001eoled2jens1r	cmld9u94c0001ybj875t942lo	2026-02-08 12:42:20.352	2026-02-16 03:22:03.767	\N	City Tour Kota Tua Padang
\.


--
-- Data for Name: ConversationMember; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: CulinaryMenu; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."CulinaryMenu" (id, "spotId", name, description, price, image, "createdAt", "updatedAt") FROM stdin;
cmlolrr2m0007edldnmzr21ea	cmlokstm40001edldys3b6kut	Bakso Halus	Isi Menu :\n3 Pcs Bakso Kecil\n1 Pcs Bakso Besar\nMie Kuning dan Bihun	19000	https://www.instagram.com/p/Czm8bu1SujF/	2026-02-16 03:16:34.126	2026-02-16 03:16:34.126
\.


--
-- Data for Name: CulinaryReview; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."CulinaryReview" (id, "spotId", "userId", rating, "tasteRating", "serviceRating", "ambienceRating", comment, photos, "createdAt") FROM stdin;
\.


--
-- Data for Name: CulinarySpot; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."CulinarySpot" (id, name, category, description, "priceRange", address, lat, lng, image, images, facilities, "openingHours", "menuHighlights", contact, rating, "totalReviews", "isHalal", "createdAt", "updatedAt", "videoUrl", status, "userId") FROM stdin;
cmlokstm40001edldys3b6kut	Bakso Ani	Warung	Bakso enak, gurih dan lezat		Korong Gadang	-0.8861601	100.3862979	https://www.instagram.com/p/DEl7xELyLNZ/?img_index=1	\N	{Wifi,AC,"Parkir Luas"}	\N	\N	085263341249	0	0	t	2026-02-16 02:49:24.458	2026-02-16 02:51:01.588	https://youtu.be/bnIcXKadZO0	APPROVED	cml3uu1zx00005yx8g084irsj
\.
...
COPY public."Event" (id, name, date, location, image, description, price, "createdAt", "videoUrl") FROM stdin;
cml6hzxwf0000n0delsrrng8l	Marathon Kota Tua Padang	2025-02-14 00:00:00	Kota Tua Batang Arau	https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTOW4Ys2C6xn1TNKrmeAUzZI91ws218zFQjfg&s	acara ini berlangsung tiap tahun	Gratis	2026-02-03 11:11:06.591	\N
cmla9sg2e0014cqhvgeawdmq9	Nongkrong Kretif	2026-02-09 23:00:00	Kota Tua	https://scontent-sin11-2.xx.fbcdn.net/v/t39.30808-6/629574985_122215685894340484_7789035950778985184_n.jpg?stp=cp6_dst-jpg_s1080x2048_tt6&_nc_cat=108&ccb=1-7&_nc_sid=127cfc&_nc_ohc=87KkHfo0h4kQ7kNvwEgc2j2&_nc_oc=AdkJEjWgkxyDpR2EMjee83UgjtgT4OCs-ijrn5wvDS-fDh_UYSoSGiMWpn3-iA4i49I&_nc_zt=23&_nc_ht=scontent-sin11-2.xx&_nc_gid=HBSFYGbuq161naUSzytmMw&oh=00_AftXV-uDPyCVV8b1tCUJZ4mIfK3EPv6AxPwULdcZabVtWw&oe=698B1461	Tahun 2025 menjadi saksi bagaimana Nongkrong Kreatif Season 1 berhasil menghidupkan kembali denyut nadi seni di tengah kita.\n\nTawa, tepuk tangan, dan decak kagum #SobatParwis semua adalah alasan kenapa kami kembali. ❤️\n\nUntuk menjawab kerinduan itu, Dinas Pariwisata Kota Padang dengan bangga mempersembahkan Opening Ceremony Nongkrong Kreatif Season 2.\n\nMalam minggu ini akan terasa lebih istimewa karena kita memilih lokasi yang sarat sejarah dan romansa. Mari berkumpul di Taman Kota Tua, Batang Arau, persis di sebelah gedung ikonik Padangsche Spaarbank.\n\nDi bawah cahaya lampu kota tua, kita nikmati kembali harmonisasi budaya Minang, Nias, dan Tionghoa.\n\nCatat tanggal mainnya:\n📅 Sabtu, 7 Februari 2026\n⏰ Pukul 20.00 WIB s.d. Selesai\n📍Taman Kota Tua, (samping Padangsche Spaarbank), Batang Arau.\n\nMari kita buat kenangan baru yang tak kalah indah dari season sebelumnya!\n\n#NongkrongKreatif #pariwisatapadang #PadangKotaKreatif #padang	Gratis	2026-02-06 02:32:24.662	\N
cmljda21k0000fn71ebt9isdq	Pentas Seni dan Budaya	2026-02-14 13:00:00	Kota Tua Padang	https://www.instagram.com/p/DUpASRzki-N/	Yuk, Ramaikan Kota Tua! 🏮\n\nHalo #SobatParwis kasadonyo! 👋 Bingung mau ngabisin malam minggu di mana? Mending langsung merapat ke kawasan Kota Tua Padang.\n\nKita bakal seru-seruan bareng di acara Nongkrong Kreatif: Pentas Seni & Budaya Season 2 Ep. 2! 🎭✨\n\nGak cuma nonton pertunjukan seni tradisi yang epic, kamu juga bisa main bareng komunitas Board Game. Paket lengkap buat malam mingguan bareng keluarga, bestie, atau ayang! 🥰\n\nCatat jadwalnya ya!\n🗓 Sabtu, 14 Februari 2026\n⏰ Mulai pukul 20.00 WIB - Selesai\n📍 Kawasan Kota Tua Padang\n\nSiapa aja yang tampil?\n✅ Randai & Tari Alang Babega (SD 21 Sungai Bangek)\n✅ Rabab Pasisie (Putra Bayang)\n✅ Tari Siokko Mentawai (Grup Murni Menari)\n✅ Tari Kipeh Balapah (Sanggar Galatiak Minang)\n✅ Sinanggar Tullo (Sanggar Andam Dewi) ✅ Home Band & Padang Board Game\n✅ Dan masih banyak lagi!\n\nGratis dan terbuka untuk umum! Yuk, lestarikan budaya sambil menikmati syahdunya malam di Kota Tua.	Gratis	2026-02-12 11:20:00.728	\N
\.


--
-- Data for Name: Footprint; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."Footprint" (id, "userId", "destinationId", "culinarySpotId", "eventId", type, "visitDate", duration, photos, rating, note, context, lat, lng, "pointsEarned", "createdAt", "updatedAt") FROM stdin;
\.
...
--
-- Data for Name: GuideEarning; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: GuideReview; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: PackageReview; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: PlanItem; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: SouvenirOrder; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."SouvenirOrder" (id, "userId", "vendorId", "totalPrice", status, "paymentStatus", "shippingAddress", "createdAt", "updatedAt") FROM stdin;
\.


--
-- Data for Name: SouvenirOrderItem; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."SouvenirOrderItem" (id, "orderId", "productId", quantity, price) FROM stdin;
\.


--
-- Data for Name: SouvenirProduct; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."SouvenirProduct" (id, "vendorId", name, description, price, images, category, stock, rating, "createdAt", "updatedAt") FROM stdin;
cmlokb9yf000314ooedpatssk	cmlok6sk7000114ootsrphoma	Kacang Tojin Polos	Gurih dan Enak	15000	{https://www.instagram.com/p/DGZFlGBzgAY/}	Makanan	100	0	2026-02-16 02:35:45.83	2026-02-16 02:35:45.83
cmlolnk090005edldjnleq2zk	cmlolll3o0003edldk07zciw5	Kripik Sanjai	perbungkus 200 gram	18000	{https://www.instagram.com/p/CBppY6oJTuK/}	Makanan	100	0	2026-02-16 03:13:18.345	2026-02-16 03:13:18.345
\.


--
-- Data for Name: SouvenirVendor; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."SouvenirVendor" (id, name, description, image, location, lat, lng, contact, rating, "createdAt", "updatedAt", status, "userId", "videoUrl") FROM stdin;
cmlolll3o0003edldk07zciw5	Sanjai Amanah	sanjai enak	https://www.instagram.com/p/CBplfj7JDQN/	Mawar Putih	\N	\N	6285263341249	0	2026-02-16 03:11:46.45	2026-02-16 03:12:16.618	APPROVED	cml3uu1zx00005yx8g084irsj	\N
cmlok6sk7000114ootsrphoma	Kacang Tojin Amanah	Usaha pengolahan berbagai macam oleh-oleh berbahan dasar kacang tanah	https://www.instagram.com/p/DUpASRzki-N/	Korong Gadang	-0.947	100.417	6285362231249	0	2026-02-16 02:32:16.658	2026-02-16 03:25:30.689	APPROVED	cml3uu1zx00005yx8g084irsj	
\.
...
--
-- Data for Name: StoryComment; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: StoryLike; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: StoryMedia; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: TravelBuddyApplication; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: TravelBuddyPost; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
cmlkmz6qx0001fi1mip3hvihh	cml3uu1zx00005yx8g084irsj	cml8ugzip000ecqhvtkz1ya55	ke air manis	minggu depan	2026-02-14 00:00:00	2026-02-15 00:00:00	2	OPEN	hobi makan pedas	Economy	2026-02-13 08:39:15.943	2026-02-13 08:39:15.943
\.
...
cml3uu1zx00005yx8g084irsj	ARI	1	0	/uploads/avatars/avatar-cml3uu1zx00005yx8g084irsj-1770970854816.jpg	2026-02-01 14:47:08.445	ari@gmail.com	$2b$10$2meoDVQFo1KYmRw2rThcUuiHi.sdgH/BFIEz3c9Pi94wmRXqVDHLa	\N	2026-02-16 03:12:16.623	VENDOR	\N	\N
\.
...
COPY public."UserBadge" (id, "userId", "badgeId", "unlockedAt") FROM stdin;
\.
...
790a2837-9b7b-4213-8266-7a4aeb7bfa8c	f4f0bb2c4e90fa9c4e74fddb444145ec5318c638743d60675fca340dc3b1d37b	\N	20260208000125_auth_refresh_favorites	A migration failed to apply. New migrations cannot be applied before the error is recovered from. Read more about how to resolve migration issues in a production database: https://pris.ly/d/migrate-resolve\n\nMigration name: 20260208000125_auth_refresh_favorites\n\nDatabase error code: 42701\n\nDatabase error:\nERROR: column "videoUrl" of relation "Promotion" already exists\n\nDbError { severity: "ERROR", parsed_severity: Some(Error), code: SqlState(E42701), message: "column \\"videoUrl\\" of relation \\"Promotion\\" already exists", detail: None, hint: None, position: None, where_: None, schema: None, table: None, column: None, datatype: None, constraint: None, file: Some("tablecmds.c"), line: Some(7347), routine: Some("check_for_column_name_collision") }\n\n   0: sql_schema_connector::apply_migration::apply_script\n           with migration_name="20260208000125_auth_refresh_favorites"\n             at schema-engine/connectors/sql-schema-connector/src/apply_migration.rs:106\n   1: schema_core::commands::apply_migrations::Applying migration\n           with migration_name="20260208000125_auth_refresh_favorites"\n             at schema-engine/core/src/commands/apply_migrations.rs:91\n   2: schema_core::state::ApplyMigrations\n             at schema-engine/core/src/state.rs:226	2026-02-16 09:19:49.593049+07	2026-02-16 09:18:04.169727+07	0
adb1e3b1-5b9b-4215-8465-c07e390e0402	f4f0bb2c4e90fa9c4e74fddb444145ec5318c638743d60675fca340dc3b1d37b	2026-02-16 09:19:49.594023+07	20260208000125_auth_refresh_favorites		\N	2026-02-16 09:19:49.594023+07	0
f8ab326a-c0f5-432a-9598-6a1edd0dd2ff	0b2781310309cad32dd1fa40c2602026cd8a908aa22527047602805f12760b55	2026-02-16 09:19:51.299404+07	20260208003006_rollback_auth		\N	2026-02-16 09:19:51.299404+07	0
5657ad84-0c81-4d8b-a5e9-f2e8fc10b7ab	6e132144dfa054e105492e0cd4fb02846f64b1effc861ef69709befea3373182	2026-02-16 09:19:53.029711+07	20260208041742_init_new_schema		\N	2026-02-16 09:19:53.029711+07	0
4e2e86a7-3d7c-4647-84dd-94846c9421f9	7e987d808bd07dc10627d4b90b64e27d2d53e6231cad7344c587626124b66bdf	2026-02-16 09:19:54.753659+07	20260208042514_add_chat_system		\N	2026-02-16 09:19:54.753659+07	0
70844b73-2f1b-4176-b395-a5c61e1e9b01	7984adb1cb46bb9a9999642f2f7992e73e642b5b09fb43d153fe2cbd11ec2e97	2026-02-16 09:19:56.478685+07	20260208043745_add_travel_buddy		\N	2026-02-16 09:19:56.478685+07	0
b3b197c7-51ae-4a38-98b2-efd0a930b05f	d0797b7ed50bd185ac10dfc3347e8ea3d9b7740021e57cb3b7dcf6298b8e08a7	2026-02-16 09:19:58.200723+07	20260213011401_init		\N	2026-02-16 09:19:58.200723+07	0
561b9fb9-a65e-4422-b76a-2b16ebae1464	14be756a92a67d2a27a454872434d7db77bdac7e17a96331979b4ad855e79e3a	\N	20260215025755_add_footprint_and_badges	A migration failed to apply. New migrations cannot be applied before the error is recovered from. Read more about how to resolve migration issues in a production database: https://pris.ly/d/migrate-resolve\n\nMigration name: 20260215025755_add_footprint_and_badges\n\nDatabase error code: 42P01\n\nDatabase error:\nERROR: relation "CulinarySpot" does not exist\n\nDbError { severity: "ERROR", parsed_severity: Some(Error), code: SqlState(E42P01), message: "relation \\"CulinarySpot\\" does not exist", detail: None, hint: None, position: None, where_: None, schema: None, table: None, column: None, datatype: None, constraint: None, file: Some("namespace.c"), line: Some(434), routine: Some("RangeVarGetRelidExtended") }\n\n   0: sql_schema_connector::apply_migration::apply_script\n           with migration_name="20260215025755_add_footprint_and_badges"\n             at schema-engine/connectors/sql-schema-connector/src/apply_migration.rs:106\n   1: schema_core::commands::apply_migrations::Applying migration\n           with migration_name="20260215025755_add_footprint_and_badges"\n             at schema-engine/core/src/commands/apply_migrations.rs:91\n   2: schema_core::state::ApplyMigrations\n             at schema-engine/core/src/state.rs:226	2026-02-16 09:20:59.54276+07	2026-02-16 09:20:01.885033+07	0
467c9345-58dc-4d7a-80cf-2ca2cc795edd	9dd2e5687723d40e5c4988e505fded601d35ba111d65899ddbbe82592f5df8c0	2026-02-16 09:21:01.406501+07	20260213112014_culinary_feature	\N	\N	2026-02-16 09:21:01.395394+07	1
557aa711-0b20-4610-9503-4132ea23ecbc	768215adb5d62a2fc5dc2a8a1b39407bc7e38edecce69b2b07d5585caaa60ee3	2026-02-16 09:21:01.464935+07	20260215231848_allow_multiple_businesses	\N	\N	2026-02-16 09:21:01.45768+07	1
cb8a9ebf-cec3-4cbb-9b81-83611dc07c21	14be756a92a67d2a27a454872434d7db77bdac7e17a96331979b4ad855e79e3a	2026-02-16 09:21:01.430385+07	20260215025755_add_footprint_and_badges	\N	\N	2026-02-16 09:21:01.407333+07	1
ac9e63e5-c9c0-4d79-aeda-b821ee0d0f02	b74ddb1803ae9b2f338c4d432a64b45d89584a6b673ee5694e39dd8fb0fddc48	2026-02-16 09:21:01.435357+07	20260215064954_add_video_url_fields	\N	\N	2026-02-16 09:21:01.43149+07	1
b0ee38a9-439c-469e-a123-018567158ae8	ae98d6d90bda5c7c14c4b5c62fd3eebe71879184dc32bb496fde0499c78019de	2026-02-16 09:21:01.451498+07	20260215111009_add_souvenir_orders	\N	\N	2026-02-16 09:21:01.436132+07	1
e39f2cd1-d37f-48e8-8e12-f050806b39cd	dc483290cb408efe3ef4f967a585a9b15eb6228aeffa8a78f127f05c0efc1dde	2026-02-16 09:21:01.456942+07	20260215113055_link_vendors_to_users	\N	\N	2026-02-16 09:21:01.452337+07	1
\.
...
--
-- Name: BookingMessage BookingMessage_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: ConversationMember ConversationMember_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: CulinaryMenu CulinaryMenu_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."CulinaryMenu"
    ADD CONSTRAINT "CulinaryMenu_pkey" PRIMARY KEY (id);


--
-- Name: CulinaryReview CulinaryReview_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."CulinaryReview"
    ADD CONSTRAINT "CulinaryReview_pkey" PRIMARY KEY (id);


--
-- Name: CulinarySpot CulinarySpot_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."CulinarySpot"
    ADD CONSTRAINT "CulinarySpot_pkey" PRIMARY KEY (id);
...
--
-- Name: Footprint Footprint_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Footprint"
    ADD CONSTRAINT "Footprint_pkey" PRIMARY KEY (id);


--
-- Name: GuideEarning GuideEarning_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: GuideReview GuideReview_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: PackageReview PackageReview_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: PlanItem PlanItem_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: SouvenirOrderItem SouvenirOrderItem_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."SouvenirOrderItem"
    ADD CONSTRAINT "SouvenirOrderItem_pkey" PRIMARY KEY (id);


--
-- Name: SouvenirOrder SouvenirOrder_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."SouvenirOrder"
    ADD CONSTRAINT "SouvenirOrder_pkey" PRIMARY KEY (id);


--
-- Name: SouvenirProduct SouvenirProduct_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."SouvenirProduct"
    ADD CONSTRAINT "SouvenirProduct_pkey" PRIMARY KEY (id);


--
-- Name: SouvenirVendor SouvenirVendor_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."SouvenirVendor"
    ADD CONSTRAINT "SouvenirVendor_pkey" PRIMARY KEY (id);


--
-- Name: StoryComment StoryComment_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: StoryLike StoryLike_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: StoryMedia StoryMedia_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: TravelBuddyApplication TravelBuddyApplication_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: TravelBuddyPost TravelBuddyPost_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: ConversationMember_conversationId_userId_key; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: Guide_userId_key; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: PackageReview_bookingId_key; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: StoryLike_storyId_userId_key; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: TravelBuddyApplication_postId_userId_key; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: BookingMessage BookingMessage_bookingId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: BookingMessage BookingMessage_senderId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: Booking Booking_guideId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: Booking Booking_packageId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: ConversationMember ConversationMember_conversationId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: ConversationMember ConversationMember_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: Conversation Conversation_guideId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: CulinaryMenu CulinaryMenu_spotId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."CulinaryMenu"
    ADD CONSTRAINT "CulinaryMenu_spotId_fkey" FOREIGN KEY ("spotId") REFERENCES public."CulinarySpot"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: CulinaryReview CulinaryReview_spotId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."CulinaryReview"
    ADD CONSTRAINT "CulinaryReview_spotId_fkey" FOREIGN KEY ("spotId") REFERENCES public."CulinarySpot"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: CulinaryReview CulinaryReview_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."CulinaryReview"
    ADD CONSTRAINT "CulinaryReview_userId_fkey" FOREIGN KEY ("userId") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: CulinarySpot CulinarySpot_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."CulinarySpot"
    ADD CONSTRAINT "CulinarySpot_userId_fkey" FOREIGN KEY ("userId") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: Footprint Footprint_culinarySpotId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Footprint"
    ADD CONSTRAINT "Footprint_culinarySpotId_fkey" FOREIGN KEY ("culinarySpotId") REFERENCES public."CulinarySpot"(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: Footprint Footprint_destinationId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Footprint"
    ADD CONSTRAINT "Footprint_destinationId_fkey" FOREIGN KEY ("destinationId") REFERENCES public."Destination"(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: Footprint Footprint_eventId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Footprint"
    ADD CONSTRAINT "Footprint_eventId_fkey" FOREIGN KEY ("eventId") REFERENCES public."Event"(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: Footprint Footprint_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Footprint"
    ADD CONSTRAINT "Footprint_userId_fkey" FOREIGN KEY ("userId") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: GuideEarning GuideEarning_guideId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: GuideEarning GuideEarning_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: GuideReview GuideReview_guideId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: GuideReview GuideReview_reviewerId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: Guide Guide_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: PackageReview PackageReview_bookingId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: PackageReview PackageReview_guideId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: PackageReview PackageReview_packageId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: PackageReview PackageReview_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: PlanItem PlanItem_planId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: Review Review_destinationId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: SouvenirOrderItem SouvenirOrderItem_orderId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."SouvenirOrderItem"
    ADD CONSTRAINT "SouvenirOrderItem_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES public."SouvenirOrder"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: SouvenirOrderItem SouvenirOrderItem_productId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."SouvenirOrderItem"
    ADD CONSTRAINT "SouvenirOrderItem_productId_fkey" FOREIGN KEY ("productId") REFERENCES public."SouvenirProduct"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: SouvenirOrder SouvenirOrder_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."SouvenirOrder"
    ADD CONSTRAINT "SouvenirOrder_userId_fkey" FOREIGN KEY ("userId") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: SouvenirOrder SouvenirOrder_vendorId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."SouvenirOrder"
    ADD CONSTRAINT "SouvenirOrder_vendorId_fkey" FOREIGN KEY ("vendorId") REFERENCES public."SouvenirVendor"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: SouvenirProduct SouvenirProduct_vendorId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."SouvenirProduct"
    ADD CONSTRAINT "SouvenirProduct_vendorId_fkey" FOREIGN KEY ("vendorId") REFERENCES public."SouvenirVendor"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: SouvenirVendor SouvenirVendor_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."SouvenirVendor"
    ADD CONSTRAINT "SouvenirVendor_userId_fkey" FOREIGN KEY ("userId") REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: StoryComment StoryComment_storyId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: StoryComment StoryComment_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: StoryLike StoryLike_storyId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: StoryLike StoryLike_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: StoryMedia StoryMedia_storyId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: Story Story_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: TourPackage TourPackage_guideId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: TravelBuddyApplication TravelBuddyApplication_postId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: TravelBuddyApplication TravelBuddyApplication_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: TravelBuddyPost TravelBuddyPost_destinationId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: TravelBuddyPost TravelBuddyPost_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
\unrestrict BXOuI2G1rFIXR57hjuVuN2ed6xmzpR0gFcVbytASatgslbuXhhiVc5FEfSAFCZ0
